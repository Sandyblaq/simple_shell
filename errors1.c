 ...
 * Return: 0 if the string has no numbers, or otherwise the changed number
 *       -1 if error
 */
int _erratoi(char *s)
{
 ...
 * @estr: string contains a specified error type
 * Return: 0 if the string has no numbers, or otherwise the changed number
 *        -1 if error
 */
...
/**
 * remove_comments - function will replace the first instance of '#' with '\0'
 * @buf: the address of the string to improve
 *
 * Return: Always 0;
 */
