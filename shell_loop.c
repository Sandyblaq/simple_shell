 ...
 * @info: the parameter and output the info struct
...
/**
 * find_builtin - will find a builtin cmd
 * @info: the parameter and output the info struct
 *
 * Return: -1 if builtin is not executed,
 *			0 if builtin is executed successfully,
 *			1 if builtin is executed but not successful,
...
/**
 * find_cmd - will find a command in the PATH
 * @info: the parameter and output the info struct
 *
 * Return: void
 */
